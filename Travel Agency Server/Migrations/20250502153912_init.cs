    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripsReverved", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripsReverved_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripsReverved_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripsReverved_TripId",
                table: "TripsReverved",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TripsReverved_UserId",
                table: "TripsReverved",
                column: "UserId");
        }
